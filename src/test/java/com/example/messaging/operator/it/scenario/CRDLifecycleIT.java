...
import com.example.messaging.operator.it.base.FixtureLoader;
...
public class CRDLifecycleIT extends ScenarioITBase {
    ...
    void testCompleteLifecycle() {
        ...
        acl.getSpec().setOperations(List.of(
            AclCRSpec.Operation.READ,
            AclCRSpec.Operation.WRITE,
            AclCRSpec.Operation.DESCRIBE
        ));
