...
public class MultiTenantIsolationIT extends ScenarioITBase {
    ...
    void testCrossTenantUpdateDenied() {
        ...
        Topic app2Topic = k8sClient.resources(Topic.class)
            .inNamespace("default")
        ...
        assertTrue(result.getMessage().contains("applicationServiceRef") ||
    ...
    void testCrossTenantReferenceDenied() {
        ...
        assertTrue(result.getMessage().contains("owned by 'app2', not 'app1'"),
    ...
    void testIndependentTenantOperations() {
        ...
        Topic app1Topic = k8sClient.resources(Topic.class)
            .inNamespace("default")
